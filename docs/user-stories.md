...
| J5  | As a developer, I can select an exact overload rather than inventing a method signature.                              | type result then `iceberg_api_get_member`                | Multi-hop evaluations 1–8                    |
